...
\title{Kajian Debit Lingkungan di Sungai Citarum Hulu}
\author{Irpan Chumaedi}
% The month and year that you submit your FINAL draft TO THE LIBRARY (May or December)
\date{Juli 2023}
\division{Magister Pengelolaan Sumber Daya Air}
\advisor{Prof.~Indratmo Soekarno}
\institution{Institut Teknologi Bandung}
\degree{Magister Teknik}
%If you have two advisors for some reason, you can use the following
% Uncommented out by CII
\altadvisor{Dr.~Yadi Suryadi MT.}
% End of CII addition

%%% Remember to use the correct department!
\department{Fakultas Teknis Sipil dan Lingkungan}
...
satu metode yang disarankan dalam aturan PP No.~38 Tahun 2011 adalah Q\textsubscript{95}.
...
\includegraphics{Debit_Lingkungan_Citarum_Irpan_Chumaedi_files/figure-latex/pressure-1.pdf}
...
\end{Highlighting}
\end{Shaded}
\includegraphics{Debit_Lingkungan_Citarum_Irpan_Chumaedi_files/figure-latex/march3plot-1.pdf}
...
\begin{figure}
\centering
\includegraphics{Debit_Lingkungan_Citarum_Irpan_Chumaedi_files/figure-latex/delaysboxplot-1.pdf}
